...
# DVE full session
# Saved on Tue Oct 31 18:21:47 2023
# Designs open: 1
...
#<Session mode="Full" path="/home/user100/VM/Ibex-Core-Verification-with-UVM/UVM_capstone/part-i/verif/DVEfiles//crash_10.31-18.21/dve_session10.31-18.21.tcl" type="Debug">
...
gui_show_window -window ${TopLevel.1} -show_state minimized -rect {{0 60} {1365 767}}
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 283} {height 302} {dock_state left} {dock_on_new_line true} {child_hier_colhier 173} {child_hier_coltype 107} {child_hier_colpd 0} {child_hier_col1 0} {child_hier_col2 1} {child_hier_col3 -1}}
...
gui_set_window_pref_key -window ${DLPane.1} -key dock_height -value_type integer -value 301
gui_set_window_pref_key -window ${DLPane.1} -key dock_offset -value_type integer -value 0
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 190} {height 302} {dock_state left} {dock_on_new_line true} {child_data_colvariable 140} {child_data_colvalue 100} {child_data_coltype 40} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
...
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 1365} {height 298} {dock_state bottom} {dock_on_new_line true}}
...
gui_show_window -window ${TopLevel.2} -show_state normal -rect {{29 79} {1332 764}}
...
gui_update_layout -id ${Wave.1} {{show_state maximized} {dock_state undocked} {dock_on_new_line false} {child_wave_left 377} {child_wave_right 921} {child_wave_colname 186} {child_wave_colvalue 187} {child_wave_col1 0} {child_wave_col2 1}}
...
gui_show_window -window ${TopLevel.3} -show_state normal -rect {{49 79} {1352 764}}
...
gui_update_layout -id ${Wave.2} {{show_state maximized} {dock_state undocked} {dock_on_new_line false} {child_wave_left 377} {child_wave_right 921} {child_wave_colname 186} {child_wave_colvalue 187} {child_wave_col1 0} {child_wave_col2 1}}
...
gui_show_window -window ${TopLevel.4} -show_state normal -rect {{59 79} {1362 764}}
...
gui_update_layout -id ${Wave.3} {{show_state maximized} {dock_state undocked} {dock_on_new_line false} {child_wave_left 377} {child_wave_right 921} {child_wave_colname 186} {child_wave_colvalue 187} {child_wave_col1 0} {child_wave_col2 1}}
...
gui_set_env SIMSETUP::SIMEXE {/home/user100/VM/Ibex-Core-Verification-with-UVM/UVM_capstone/part-i/verif/simv}
...
set _session_group_5 ins_if
gui_sg_create "$_session_group_5"
set ins_if "$_session_group_5"

gui_sg_addsignal -group "$_session_group_5" { tb_top.ins_if.instr_gnt_i tb_top.ins_if.instr_req_o tb_top.ins_if.instr_addr_o tb_top.ins_if.instr_rdata_i tb_top.ins_if.instr_err_i tb_top.ins_if.instr_rvalid_i tb_top.ins_if.clk {tb_top.ins_if.$unit} }

set _session_group_6 data_if
gui_sg_create "$_session_group_6"
set data_if "$_session_group_6"

gui_sg_addsignal -group "$_session_group_6" { tb_top.data_if.data_err_i tb_top.data_if.data_rdata_i tb_top.data_if.data_wdata_o tb_top.data_if.data_rvalid_i tb_top.data_if.clk tb_top.data_if.data_addr_o tb_top.data_if.data_gnt_i tb_top.data_if.data_we_o tb_top.data_if.data_be_o tb_top.data_if.data_req_o {tb_top.data_if.$unit} }
...
gui_view_scroll -id ${Hier.1} -vertical -set 170
...
gui_list_show_data -id ${Data.1} {tb_top.data_if}
...
gui_wv_zoom_timerange -id ${Wave.1} 1494 1794
gui_list_add_group -id ${Wave.1} -after {New Group} {u_top}
...
gui_list_set_filter -id ${Wave.1} -list { {Buffer 0} {Input 1} {Others 0} {Linkage 0} {Output 1} {Parameter 0} {All 0} {Aggregate 0} {LibBaseMember 0} {Event 0} {Assertion 0} {Constant 0} {Interface 0} {BaseMembers 0} {Signal 0} {$unit 0} {Inout 0} {Variable 0} }
gui_list_set_filter -id ${Wave.1} -text {*}
gui_list_set_insertion_bar  -id ${Wave.1} -group u_top  -position in
...
gui_wv_zoom_timerange -id ${Wave.2} 1494 1794
gui_list_add_group -id ${Wave.2} -after {New Group} {ins_if}
...
gui_list_set_insertion_bar  -id ${Wave.2} -group ins_if  -position in
...
gui_wv_zoom_timerange -id ${Wave.3} 1494 1794
gui_list_add_group -id ${Wave.3} -after {New Group} {data_if}
...
gui_list_set_insertion_bar  -id ${Wave.3} -group data_if  -position in

gui_marker_move -id ${Wave.3} {C1} 0
