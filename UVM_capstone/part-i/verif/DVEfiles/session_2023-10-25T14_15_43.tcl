...
# DVE full session
# Saved on Wed Oct 25 14:15:43 2023
# Designs open: 1
#   Sim: /home/user100/VM/UVM_capstone/part-i/verif/simv
...
#<Session mode="Full" path="/home/user100/VM/UVM_capstone/part-i/verif/DVEfiles/session.tcl" type="Debug">
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 287} {height 298} {dock_state left} {dock_on_new_line true} {child_hier_colhier 173} {child_hier_coltype 107} {child_hier_colpd 0} {child_hier_col1 0} {child_hier_col2 1} {child_hier_col3 -1}}
...
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 194} {height 298} {dock_state left} {dock_on_new_line true} {child_data_colvariable 140} {child_data_colvalue 100} {child_data_coltype 40} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
...
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 1365} {height 302} {dock_state bottom} {dock_on_new_line true}}
...
if { ![gui_is_db_opened -db {/home/user100/VM/UVM_capstone/part-i/verif/simv}] } {
gui_sim_run Ucli -exe simv -args { -ucligui} -dir /home/user100/VM/UVM_capstone/part-i/verif -nosource
}
}
...
set _session_group_1 ins_if
gui_sg_create "$_session_group_1"
set ins_if "$_session_group_1"

gui_sg_addsignal -group "$_session_group_1" { tb_top.ins_if.instr_gnt_i tb_top.ins_if.instr_req_o tb_top.ins_if.instr_addr_o tb_top.ins_if.instr_rdata_i tb_top.ins_if.instr_err_i tb_top.ins_if.instr_rvalid_i tb_top.ins_if.clk {tb_top.ins_if.$unit} }
...
catch {gui_list_select -id ${Hier.1} {tb_top.ins_if}}
gui_view_scroll -id ${Hier.1} -vertical -set 194
...
gui_list_show_data -id ${Data.1} {tb_top.ins_if}
